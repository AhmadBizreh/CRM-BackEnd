        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Addresses_Customer_CustomerId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sales_Addresses_AddressId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SalesorderDetailId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Price = table.Column<decimal>(nullable: false),
                    Orderedqty = table.Column<decimal>(nullable: false),
                    Taxamount = table.Column<decimal>(nullable: false),
                    SalesId1 = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesorderDetail_Product_ProductId1",
                        column: x => x.ProductId1,
                        principalTable: "Product",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SalesorderDetail_Sales_SalesId1",
                        column: x => x.SalesId1,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesorderDetail_ProductId1",
                table: "SalesorderDetail",
                column: "ProductId1");

            migrationBuilder.CreateIndex(
                name: "IX_SalesorderDetail_SalesId1",
                table: "SalesorderDetail",
                column: "SalesId1");
        }
